        ...
        >
            ...
            <div>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        ...
                        <Dropdown.Item onClick={() => handleYearFilterClick("2024")}>
                            2024
                        </Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            ...
            <Table
                className="table table-dark table-striped table-hover
                     table-bordered border-dark align-middle caption-top table-responsive table-caption-white"
            >
                <caption className="white-caption">List of expenses:</caption>
